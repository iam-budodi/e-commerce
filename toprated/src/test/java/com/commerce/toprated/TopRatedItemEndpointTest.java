...
public class TopRatedItemEndpointTest {
	...
	public static WebArchive createDeployment() {
		return ShrinkWrap.create(WebArchive.class).addClass(RatedItem.class).addClass(RatedItems.class)
				.addClass(ResourceProducer.class).addClass(RestApplication.class).addClass(TopRatedItemEndpoint.class)
