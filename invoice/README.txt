...
a persistence unit "invoicePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "invoice/pom.xml":
...
artifact ("invoice.war") is already built. You can build
