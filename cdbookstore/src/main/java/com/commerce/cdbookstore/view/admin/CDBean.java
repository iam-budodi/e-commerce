 ...
 * <p/>
 * This class provides CRUD functionality for all CD entities. It focuses purely
 * on Java EE 6 standards (e.g. <tt>&#64;ConversationScoped</tt> for state
 * management, <tt>PersistenceContext</tt> for persistence,
...
public class CDBean implements Serializable {
	...
	public void paginate() {
		...
		TypedQuery<CD> query = this.entityManager.createQuery(
	...
	public List<CD> getAll() {
		...
		return this.entityManager
						.createQuery(criteria.select(criteria.from(CD.class)))
						.getResultList();
	}
