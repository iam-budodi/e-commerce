...
a persistence unit "topratedPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "toprated/pom.xml":
...
artifact ("toprated.war") is already built. You can build
