...
/**
 * @author japhet Entity implementation class for Entity: User
 *
 */
@Entity(name = "User")
@Table(name = "t_user")
...
//	@Past // Find ways to work with LocalDate and @Past
	...
	public String toString() {
		return "User [id=" + id + ", version=" + version + ", firstName="
					...
					+ telephone + ", email=" + email + ", login=" + login
					+ ", password=" + password + ", uuid=" + uuid + ", role="
